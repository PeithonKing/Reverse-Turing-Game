...
def play(agents, conversation_history, voting_history):
    ...
    for agent in agents:
        ...
        voting_history.append(response)
    ...
    for agent in voting_responses.values():
    ...
    return conversation_history + voting_history, voting_history, agents
...
def main():
    ...
    conversation_history, voting_history = [], []

    while True:
        result = play(agents, conversation_history, voting_history)
        if not result:
            print("You have been eliminated! Game over.")
            break
        else:
            conversation_history, voting_history, agents = result
